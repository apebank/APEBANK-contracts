...
contract BOBA is LibNote {
  ...
  event Transfer(address indexed src, address indexed dst, uint wad);
    ...
    modifier auth {
        require(wards[msg.sender] == 1, "BOBA/not-authorized");
        _;
    }

    // --- ERC20 Data ---
    string  public constant name     = "BOBA Token";
    ...
    function transferFrom(address src, address dst, uint wad) public returns (bool) {
      ...
      require(balanceOf[src] >= wad, "BOBA/insufficient-balance");
