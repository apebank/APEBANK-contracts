...
// File: contracts/interfaces/IAPEBond.sol
...
// File: contracts/APEBondHelper.sol
...
contract APEBondHelper is Ownable {
    using SafeMath for uint256;
    ...
    function deposit(
        ...
        vars.lpToken = IAPEBond(vars.bond).principle();
    ...
    function _depositLiquidity(address recipient_, DepositVars memory vars_) internal {
        ...
        IAPEBond(vars_.bond).deposit(liquidity, vars_.maxPrice, recipient_);
    }
